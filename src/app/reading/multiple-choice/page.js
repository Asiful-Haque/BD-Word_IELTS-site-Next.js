...
function MultipleChoicePage() {
  // // You can manage the state of selected options here if needed
  ...
  return (
      <div className="h-screen flex flex-col">
          ...
          <div className="flex flex-1 h-screen p-4 bg-[#CFFFDC] pb-26">
              {/* Left side - Passage */}
              <div className="flex-1 overflow-auto p-4 border-r-2 border-gray-300">
                  <h2 className="text-xl font-semibold mb-4">{passageData.title}</h2>
                  <div className="text-justify">{passageData.passage}</div>
              </div>
              ...
              <div className="flex-1 overflow-auto p-4">
                  <div className="space-y-4">
                      {questionsData.map((question) => (
                          <div key={question.id} className="bg-gray-400 p-4 rounded-lg shadow-md">
